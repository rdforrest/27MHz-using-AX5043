void loop() {
  ...
  // Send Packet
  uint16_t configure4[2][10]  = { {0x28, 0x29, 0x29, 0x29, 0x29, 0x29, 0x29, 0x29, 0x29, 0x28} , { 0x03, 0x62, 0x18, 0x14, 0x55, 0xE1, 0x19, 0x03, 0x75BCD15, 0x04 } }; // configuration values into array
