...
// For 16 Mhz Crystal with 5 pF capacitance. RF 458.75 MHz. AFSK modulation. Power 16dBm. 
// For crystal test, clock frequency divided by 16, so 1MHz should be output on SYSCLK (Pin 13)
/*  SPI connections
    Uno/Nano      AX5043
    MOSI  11      17
    MISO  12      16
