...
void setup() {
  ...
  // uint16_t configure1[2][10]  = { { 0xF10, 0xF11, 0xF35, 0x184, 0xF34, 0x032, 0x34, 0x35, 0x36, 0x37, }, { 0x03, 0x07, 0x10, 0x00, 0x28, 0x34, 0x01, 0xB8, 0x00, 0x00,  } }; // configuration values into array for 27.5 MHz
  // uint16_t configure1[2][10]  = { { 0xF10, 0xF11, 0xF35, 0x184, 0xF34, 0x032, 0x34, 0x35, 0x36, 0x37, }, { 0x03, 0x07, 0x10, 0x00, 0x28, 0x34, 0x01, 0xC0, 0x00, 0x00,  } }; // configuration values into array for 28 MHz
  // uint16_t configure1[2][10]  = { { 0xF10, 0xF11, 0xF35, 0x184, 0xF34, 0x032, 0x34, 0x35, 0x36, 0x37, }, { 0x03, 0x07, 0x10, 0x00, 0x28, 0x34, 0x01, 0xE0, 0x00, 0x00,  } }; // configuration values into array for 30 MHz
  // uint16_t configure1[2][10]  = { { 0xF10, 0xF11, 0xF35, 0x184, 0xF34, 0x032, 0x34, 0x35, 0x36, 0x37, }, { 0x03, 0x07, 0x10, 0x00, 0x28, 0x34, 0x02, 0x80, 0x00, 0x00,  } }; // configuration values into array for 40 MHz
  // uint16_t configure1[2][10]  = { { 0xF10, 0xF11, 0xF35, 0x184, 0xF34, 0x032, 0x34, 0x35, 0x36, 0x37, }, { 0x03, 0x07, 0x10, 0x00, 0x28, 0x34, 0x01, 0xDB, 0x33, 0x33,  } }; // configuration values into array for 29.7 MHz
  // uint16_t configure1[2][10]  = { { 0xF10, 0xF11, 0xF35, 0x184, 0xF34, 0x032, 0x34, 0x35, 0x36, 0x37, }, { 0x03, 0x07, 0x10, 0x00, 0x28, 0x04, 0x1B, 0x10, 0x00, 0x00,  } }; // configuration values into array for 433 MHz
  // uint16_t configure1[2][10]  = { { 0xF10, 0xF11, 0xF35, 0x184, 0xF34, 0x032,0x34, 0x35, 0x36, 0x37, }, { 0x03, 0x07, 0x10, 0x00, 0x28, 0x04, 0x1B, 0x20, 0x00, 0x00,  } }; // configuration values into array for 434 MHz
  // uint16_t configure1[2][10]  = { { 0xF10, 0xF11, 0xF35, 0x184, 0xF34, 0x032, 0x34, 0x35, 0x36, 0x37, }, { 0x03, 0x07, 0x10, 0x00, 0x28, 0x04, 0x1B, 0x38, 0x00, 0x00,  } }; // configuration values into array for 435,50 MHz
