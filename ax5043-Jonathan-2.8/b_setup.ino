...
void setup() {
  ...
  uint16_t configure1[2][11]  = { { 0xF10, 0xF11, 0xF35, 0x184, 0xF34, 0x032, 0x34, 0x35, 0x36, 0x37, }, { 0x03, 0x07, 0x10, 0x10, 0x28, 0x04, 0x1B, 0x47, 0x33, 0x34,  } }; // configuration values into array for 436.45 MHz
  // uint16_t configure1[2][11]  = { { 0xF10, 0xF11, 0xF35, 0x184, 0xF34, 0x032,0x34, 0x35, 0x36, 0x37, }, { 0x03, 0x07, 0x10, 0x10, 0x28, 0x04, 0x19, 0xB7, 0x85, 0x85,  } }; // configuration values into array for 435,50 MHz
  // uint16_t configure1[2][11]  = { { 0xF10, 0xF11, 0xF35, 0x184, 0xF34, 0x032,0x34, 0x35, 0x36, 0x37, }, { 0x03, 0x07, 0x10, 0x10, 0x28, 0x04, 0x19, 0x9F, 0x72, 0xC0,  } }; // configuration values into array for 433 MHz
  // uint16_t configure1[2][11]  = { { 0xF10, 0xF11, 0xF35, 0x184, 0xF34, 0x032,0x34, 0x35, 0x36, 0x37, }, { 0x03, 0x07, 0x10, 0x10, 0x28, 0x04, 0x19, 0xA0, 0xD8, 0xB8,  } }; // configuration values into array for 434 MHz
  for (int i = 0; i < 11; i++)
  {
    for (int j = 0; j < 1; j++)
    {
  ...
  uint16_t regVal = 0x18; //VCORA set to 8
  writeRegister(regAddr, regVal); // Function call

  delay(10000); // wait for 10 secs for auto ranging
