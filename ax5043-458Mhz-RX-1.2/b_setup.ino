...
uint16_t configure2[2][22]; // Declare array
...
void setup() {
  ...
  // uint16_t configure1[2][10]  = { { 0xF10, 0xF11, 0xF35, 0x184, 0xF34, 0x032, 0x34, 0x35, 0x36, 0x37, }, { 0x03, 0x07, 0x10, 0x02, 0x28, 0x1C, 0x01, 0xB1, 0x99, 0x9A,  } }; // configuration values into array for 27.1 MHz
  ...
  // Note that Afskmark and Afkspace registers (0x110, 0x111, 0x112, 0x113) are different for TX & RX  (RX values are  0x00, 0xD9, 0x00, 0x76,)
  ...
  Serial.print("\n"); //newline
  Serial.print("AX5043 RX configuration finished");
  Serial.print("\n"); //newline
  Serial.print("\n"); //newline
