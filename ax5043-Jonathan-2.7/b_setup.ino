...
void setup() {
  ...
  uint16_t configure1[2][11]  = { { 0xF10, 0xF11, 0xF35, 0x032, 0x021, 0xF34, 0x032, 0x34, 0x35, 0x36, 0x37, }, { 0x03, 0x07, 0x10, 0x00, 0x04, 0x28, 0x04, 0x1B, 0x47, 0x33, 0x34,  } }; // configuration values into array for 436.45 MHz
  // uint16_t configure1[2][11]  = { { 0xF10, 0xF11, 0xF35, 0x032, 0x021, 0xF34, 0x032, 0x34, 0x35, 0x36, 0x37, }, { 0x03, 0x07, 0x10, 0x00, 0x04, 0x28, 0x04, 0x19, 0xB7, 0x85, 0x85,  } }; // configuration values into array for 435,50 MHz
  for (int i = 0; i < 11; i++)
  {
    for (int j = 0; j < 1; j++)
    {
  ...
  if ( value & 0x10 )      // test bit shown. Test if both are true.
